package com.xinning.xinningweather;
...
import com.xinning.xinningweather.gson.Forecast;
...
import static com.xinning.xinningweather.util.Utility.handleWeatherResponse;
...
public class WeatherActivity  extends AppCompatActivity{
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(url, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ToastUtil.show(getBaseContext(),"请求失败");
                return;
            }
     ...
     * @param weatherId
     */
    private void requestWeathera(String weatherId) {
        ...
        HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                 runOnUiThread(new Runnable() {
                     @Override
                     public void run() {
                         ToastUtil.show(getBaseContext(),"获取天气失败");
                     }
                 });
            }
